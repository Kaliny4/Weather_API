from db_code.app.extract.specialisterne import SpecAPI
from db_code.app.extract.new_specialisterne import NewSpecAPI
from db_code.app.extract.dmi import DMIAPI
from db_code.app.transform.transform import SpecDataTransformer, DMIDataTransformer
